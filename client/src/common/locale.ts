...
const aliases = {
    ...
    'item_desc_resourceCost': 'Цена',
    'item_desc_served': 'Отпарвлено в метрополию',
    'item_desc_ready': 'Готово к производству',
    ...
    'flight_desc_kind': 'Вариант вылета',
    ...
    'flight_kind_0': 'Обычный',
    'flight_kind_1': 'Научный',
    'log_group_desc_kind': 'Группа события',
    'log_group_0': 'Ресурсы',
    'log_group_1': 'Патенты',
    'log_group_2': 'Торговля',
    'log_group_3': 'Заказы',
    'log_group_4': 'Финансы',
    'log_group_5': 'Полеты',
